...
let
  py2hwsw_commit = "5ee2131f40482d1e0d3f2d04002deeff8705054b"; # Replace with the desired commit.
  py2hwsw_sha256 = "cy19oUYXIajFQgkOdSwLZGVaAE67dgiAZa8L73bWP9k="; # Replace with the actual SHA256 hash.
