...
let
  py2hwsw_commit = "fb7127ddc77ff6f061a03c633534eb7c1dcdd04c"; # Replace with the desired commit.
  py2hwsw_sha256 = "+FlIWm/mjZ8yZeRAbBtz4CAdIrUjBUmprJpK1xRSp54="; # Replace with the actual SHA256 hash.
