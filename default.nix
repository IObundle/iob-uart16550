...
let
  py2hwsw_commit = "a9ee0980562fc4e8d7d5b8ed0771f20e500db6d2"; # Replace with the desired commit.
  py2hwsw_sha256 = "rAo5z67FR460I2Iu0IaDkG9qZJlZzdZYneNn54L8UV0="; # Replace with the actual SHA256 hash.
